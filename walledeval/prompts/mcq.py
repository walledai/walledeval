...
from walledeval.constants import DEFAULT_OPTIONS, DEFAULT_SAMPLE_QUESTION, DEFAULT_OPTION_FORMAT
...
class MultipleChoiceTemplate(PromptTemplate):
    ...
    def __init__(self, 
        ...
        Args:
            template (str): A string with $-delimited substitutions. MUST contain $question, $options and $choices.
...
class FewShotMCQTemplate(MultipleChoiceTemplate):
    ...
    def __init__(self,
        ...
        Args:
            ...
            boxed_answer (bool, optional): Whether or not to box up the sample answers.
        """
