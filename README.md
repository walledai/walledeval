...
WalledEval's LLM architecture aims to support various kinds of LLMs, with a current focus on Decoder-only and MoE architectures. These LLMs are used as **systems-under-test (SUTs)**, which allows generating question answers and prompt outputs.
